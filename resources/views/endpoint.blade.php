                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8 w-full">
                    <div
                        ...
                        <div>
                            ...
                            <h3>Server url: http://20.115.82.62:6969/</h3>
                            <div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                <div class="container mx-auto px-4 py-5">
                                    ...
                                    @php
                                        $sections = ['Authentications', 'Company Authenticated', 'Guest', 'User Authenticated'];
                                    @endphp
                                            ...
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    <th
                                                        ...
                                                        <input class="form-check-input" style="accent-color: red"
                                                            type="checkbox" id="exampleCheckbox" name="exampleCheckbox"
                                                            disabled checked>
                                                    </th>
                                                    <th
                                                        class="px-6 py-3 sm:text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                @foreach ($endpoints[$section] as $endpoint)
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">{{ $endpoint->method }}
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="form-group"
                                    ...
                                    <input type="text" placeholder="endpoint"
                                        style="border-width: 2px; border-radius: 7px">
